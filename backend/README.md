...
生成风格不仅是展示标签：轻爵士使用七和弦、摇摆 comping 与 walking bass；Lo-fi 使用轻摇摆；史诗风扩大力度、音域并使用低音级进；国风使用五声音阶与开放五度；极简氛围使用踏板低音和长延音；摇滚使用根音—五度—八度低音，并在段首加入 crash、段尾加入 tom fill。低活跃小节会让旋律、和声、低音及鼓组同步呼吸。浏览器播放器加入风格化混响和延音模拟，采样失败时使用柔和包络降级。
